...
public class RestUI extends HttpServlet {
    ...
    public final static byte[] ico;
    
    static {
        ico = Files.readResource("cn/framework/rest/resource/f.ico");
    }
     ...
     * api列表html页面
     */
    public final static String API_LIST_HTML_TEMPLATE = Files.readResourceText("cn/framework/rest/resource/api.html");
    
    /**
     * api详情html页面
     */
    public final static String API_DETAIL_HTML_TEMPLATE = Files.readResourceText("cn/framework/rest/resource/detail.html");
